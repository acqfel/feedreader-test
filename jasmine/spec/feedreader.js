...
$(function() {
    ...
    */
    ...
    /* Th a new test suite named "Initial Entries" */
    describe("Initial Entries", function() {
        ...
        it("after loading the feed (loadFeed function), checks if within the .feed container there is at least a single .entry element", function(done) {
            // $('.feed .entry-link .entry').length
            // is the amount of articles in the News Feed (inside the .feed container)
            // that have the .entry class
